        ...
        <Row type="flex" justify="space-around">
            <Col span={24}>
                ...
                <SliderInput
                    ...
                    description={`Offset in pixels of the x coordinate of the control point. The control point is placed relative to the inner starting point of the petal. There is only one control point that both lines of the petal will arc towards.`}
                ...
                <SliderInput
                    ...
                    description={`Offset in pixels of the y coordinate of the control point. The control point is placed relative to the inner starting point of the petal.  There is only one control point that both lines of the petal will arc towards.`}
